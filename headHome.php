...
session_start();
    ...
    $query="SELECT c_id,type_crime,d_o_c,location from complaint where location='Anandapur' OR location='Tollygunge' OR location='Vellore' OR location='Jaipur' order by c_id desc";
